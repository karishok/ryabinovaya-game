(function (root, factory) {
  ...
  const LEVELS = [
    ...
    },
    {
      ...
      stock: { dry: { water: 0 } },
      events: [],
      goal: 'Примите поставку, разместите паллету в зоне хранения и закройте заявку.',
      storyBefore: 'На приёмке стоит фура с водой, а на складе её нет. Сначала приёмка — потом отгрузка.',
